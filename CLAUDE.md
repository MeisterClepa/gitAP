...
- `dccccc/add` — [schema](.agent/rules/mcp-functions/dccccc/add.json)
- `dccccc/subtract` — [schema](.agent/rules/mcp-functions/dccccc/subtract.json)
- `dccccc/multiply` — [schema](.agent/rules/mcp-functions/dccccc/multiply.json)
- `dccccc/division` — [schema](.agent/rules/mcp-functions/dccccc/division.json)
- `dccccc/sum` — [schema](.agent/rules/mcp-functions/dccccc/sum.json)
- `dccccc/modulo` — [schema](.agent/rules/mcp-functions/dccccc/modulo.json)
- `dccccc/mean` — [schema](.agent/rules/mcp-functions/dccccc/mean.json)
- `dccccc/median` — [schema](.agent/rules/mcp-functions/dccccc/median.json)
- `dccccc/mode` — [schema](.agent/rules/mcp-functions/dccccc/mode.json)
- `dccccc/min` — [schema](.agent/rules/mcp-functions/dccccc/min.json)
- `dccccc/max` — [schema](.agent/rules/mcp-functions/dccccc/max.json)
- `dccccc/floor` — [schema](.agent/rules/mcp-functions/dccccc/floor.json)
- `dccccc/ceiling` — [schema](.agent/rules/mcp-functions/dccccc/ceiling.json)
- `dccccc/round` — [schema](.agent/rules/mcp-functions/dccccc/round.json)
- `dccccc/sin` — [schema](.agent/rules/mcp-functions/dccccc/sin.json)
- `dccccc/arcsin` — [schema](.agent/rules/mcp-functions/dccccc/arcsin.json)
- `dccccc/cos` — [schema](.agent/rules/mcp-functions/dccccc/cos.json)
- `dccccc/arccos` — [schema](.agent/rules/mcp-functions/dccccc/arccos.json)
- `dccccc/tan` — [schema](.agent/rules/mcp-functions/dccccc/tan.json)
- `dccccc/arctan` — [schema](.agent/rules/mcp-functions/dccccc/arctan.json)
- `dccccc/radiansToDegrees` — [schema](.agent/rules/mcp-functions/dccccc/radiansToDegrees.json)
- `dccccc/degreesToRadians` — [schema](.agent/rules/mcp-functions/dccccc/degreesToRadians.json)
