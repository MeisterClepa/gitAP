...
- `mcpSearch.add` — Adds two numbers together
  Schema: .agent/mcp-functions/mcpSearch/add.json
- `mcpSearch.subtract` — Subtracts the second number from the first number
  Schema: .agent/mcp-functions/mcpSearch/subtract.json
- `mcpSearch.multiply` — Multiplies two numbers together
  Schema: .agent/mcp-functions/mcpSearch/multiply.json
- `mcpSearch.division` — Divides the first number by the second number
  Schema: .agent/mcp-functions/mcpSearch/division.json
- `mcpSearch.sum` — Adds any number of numbers together
  Schema: .agent/mcp-functions/mcpSearch/sum.json
- `mcpSearch.modulo` — Divides two numbers and returns the remainder
  Schema: .agent/mcp-functions/mcpSearch/modulo.json
- `mcpSearch.mean` — Calculates the arithmetic mean of a list of numbers
  Schema: .agent/mcp-functions/mcpSearch/mean.json
- `mcpSearch.median` — Calculates the median of a list of numbers
  Schema: .agent/mcp-functions/mcpSearch/median.json
- `mcpSearch.mode` — Finds the most common number in a list of numbers
  Schema: .agent/mcp-functions/mcpSearch/mode.json
- `mcpSearch.min` — Finds the minimum value from a list of numbers
  Schema: .agent/mcp-functions/mcpSearch/min.json
- `mcpSearch.max` — Finds the maximum value from a list of numbers
  Schema: .agent/mcp-functions/mcpSearch/max.json
- `mcpSearch.floor` — Rounds a number down to the nearest integer
  Schema: .agent/mcp-functions/mcpSearch/floor.json
- `mcpSearch.ceiling` — Rounds a number up to the nearest integer
  Schema: .agent/mcp-functions/mcpSearch/ceiling.json
- `mcpSearch.round` — Rounds a number to the nearest integer
  Schema: .agent/mcp-functions/mcpSearch/round.json
- `mcpSearch.sin` — Calculates the sine of a number in radians
  Schema: .agent/mcp-functions/mcpSearch/sin.json
- `mcpSearch.arcsin` — Calculates the arcsine of a number in radians
  Schema: .agent/mcp-functions/mcpSearch/arcsin.json
- `mcpSearch.cos` — Calculates the cosine of a number in radians
  Schema: .agent/mcp-functions/mcpSearch/cos.json
- `mcpSearch.arccos` — Calculates the arccosine of a number in radians
  Schema: .agent/mcp-functions/mcpSearch/arccos.json
- `mcpSearch.tan` — Calculates the tangent of a number in radians
  Schema: .agent/mcp-functions/mcpSearch/tan.json
- `mcpSearch.arctan` — Calculates the arctangent of a number in radians
  Schema: .agent/mcp-functions/mcpSearch/arctan.json
- `mcpSearch.radiansToDegrees` — Converts a radian value to its equivalent in degrees
  Schema: .agent/mcp-functions/mcpSearch/radiansToDegrees.json
- `mcpSearch.degreesToRadians` — Converts a degree value to its equivalent in radians
  Schema: .agent/mcp-functions/mcpSearch/degreesToRadians.json
